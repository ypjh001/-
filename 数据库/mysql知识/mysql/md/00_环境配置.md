...
![1558850718347](../img/20210118205846.png)

![](../img/20201213193507.png)

![image-20201213193754229](../img/20201213193754.png)

> 如果不需要的话，可以删除mysql所在文件夹，安装新的mysql。

### 1.1.2 windows上安装最新版的mysql
...
![image-20201213201114897](../img/20201213201115.png)

![image-20201213200718982](../img/20201213200719.png)

![image-20201213201201866](../img/20201213201202.png)

next-> next ->execute  -> finish -> next -> finish -> check密码，通过后next -> finish ->next -> finish

安装完成

### 1.1.3 连接 MySQL 并执行 SQL 查询

在安装成功MySQL后, 我们可以通过开始菜单->控制面板->管理工具->服务中查找并开启或关闭MySQL服务.

![image-20201213202205300](../img/20201213202205.png)

开启后，在开始菜单中进入，并输入密码，将登陆成功。

![image-20201213202359387](../img/20201213202359.png)

- 使用mysql自带的Mysql Workbench连接Mysql

> MySQL Workbench 是一款功能强大的数据库管理工具, 它既可以用于设计数据库, 也可以用于连接数据库进行查询.

![image-20201213202829239](../img/20201213202829.png)

### 1.1.4 一些其它的第三方连接数据库的软件
...
![image-20201213205550750](../img/20201213205550.png)

![image-20201213205617805](../img/20201213205617.png)

![image-20201213210428377](../img/20201213210428.png)
