...
## [安装Sentinel控制台](http://www.macrozheng.com/#/cloud/sentinel?id=安装sentinel控制台)
...
![img](http://www.macrozheng.com/images/spingcloud_sentinel_01.png)

- Sentinel控制台可以查看单台机器的实时监控数据。

![img](http://www.macrozheng.com/images/spingcloud_sentinel_07.png)

## [创建sentinel-service模块](http://www.macrozheng.com/#/cloud/sentinel?id=创建sentinel-service模块)
...
## [限流功能](http://www.macrozheng.com/#/cloud/sentinel?id=限流功能)

> Sentinel Starter 默认为所有的 HTTP 服务提供了限流埋点，我们也可以通过使用@SentinelResource来自定义一些限流行为。

### [创建RateLimitController类](http://www.macrozheng.com/#/cloud/sentinel?id=创建ratelimitcontroller类)
...
### [根据资源名称限流](http://www.macrozheng.com/#/cloud/sentinel?id=根据资源名称限流)
...
![img](http://www.macrozheng.com/images/spingcloud_sentinel_02.png)

- 快速访问上面的接口，可以发现返回了自己定义的限流处理信息：

![img](http://www.macrozheng.com/images/spingcloud_sentinel_03.png)

### [根据URL限流](http://www.macrozheng.com/#/cloud/sentinel?id=根据url限流)

> 我们还可以通过访问的URL来限流，会返回默认的限流处理信息。

- 在Sentinel控制台配置流控规则，使用访问的URL：

![img](http://www.macrozheng.com/images/spingcloud_sentinel_04.png)

- 多次访问该接口，会返回默认的限流处理结果：http://localhost:8401/rateLimit/byUrl

![img](http://www.macrozheng.com/images/spingcloud_sentinel_05.png)

### [自定义限流处理逻辑](http://www.macrozheng.com/#/cloud/sentinel?id=自定义限流处理逻辑)
...
## [熔断功能](http://www.macrozheng.com/#/cloud/sentinel?id=熔断功能)
...
![img](http://www.macrozheng.com/images/spingcloud_sentinel_06.png)

## [与Feign结合使用](http://www.macrozheng.com/#/cloud/sentinel?id=与feign结合使用)
...
## [使用Nacos存储规则](http://www.macrozheng.com/#/cloud/sentinel?id=使用nacos存储规则)

> 默认情况下，当我们在Sentinel控制台中配置规则时，控制台推送规则方式是通过API将规则推送至客户端并直接更新到内存中。一旦我们重启应用，规则将消失。下面我们介绍下如何将配置规则进行持久化，以存储到Nacos为例。

### [原理示意图](http://www.macrozheng.com/#/cloud/sentinel?id=原理示意图)

![img](http://www.macrozheng.com/images/spingcloud_sentinel_08.png)

- 首先我们直接在配置中心创建规则，配置中心将规则推送到客户端；
- Sentinel控制台也从配置中心去获取配置信息。

### [功能演示](http://www.macrozheng.com/#/cloud/sentinel?id=功能演示)
...
![img](http://www.macrozheng.com/images/spingcloud_sentinel_09.png)
...
![img](http://www.macrozheng.com/images/spingcloud_sentinel_10.png)

- 快速访问测试接口，可以发现返回了限流处理信息：

![img](http://www.macrozheng.com/images/spingcloud_sentinel_11.png)

## [参考资料](http://www.macrozheng.com/#/cloud/sentinel?id=参考资料)

Spring Cloud Alibaba 官方文档：https://github.com/alibaba/spring-cloud-alibaba/wiki

## [使用到的模块](http://www.macrozheng.com/#/cloud/sentinel?id=使用到的模块)
