...
### [在启动类上添加@EnableFeignClients注解来启用Feign的客户端功能](http://www.macrozheng.com/#/cloud/feign?id=在启动类上添加enablefeignclients注解来启用feign的客户端功能)
...
## [Feign的常用配置](http://www.macrozheng.com/#/cloud/feign?id=feign的常用配置)
