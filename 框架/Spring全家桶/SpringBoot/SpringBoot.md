...
![Spring官网首图](spring5.assets\Snipaste_2020-09-27_10-33-00.png)

我们可以看到图中官方对 Spring Boot 的定位：<font color=#FF0000 >**Build Anything** </font>， Build任何东西。Spring Boot旨在尽可能快地启动和运行，并且只需最少的 Spring 前期配置。  同时我们也来看一下官方对后面两个的定位：

<font color=#FF0000 >SpringCloud：*Coordinate Anything*，协调任何事情</font>

<font color=#FF0000 >SpringCloud Data Flow：*Connect everything*，连接任何东西。</font>  
...
![Spring Boot的优点](spring5.assets\Snipaste_2020-09-27_10-34-17.png)
...
![Spring Boot与Spring](SpringBoot.assets/Snipaste_2020-09-27_10-34-51.png)
...
在使用 Spring 时，项目部署时需要我们在服务器上部署 tomcat，然后把项目打成 war 包扔到 tomcat里，在使用 Spring Boot 后，我们不需要在服务器上去部署 tomcat，因为 Spring Boot 内嵌了 tomcat，我们只需要将项目打成 jar 包，使用 <font color=#FF0000 >`java -jar xxx.jar`</font>一键式启动项目。
...
![IDEA中配置jdk](SpringBoot.assets/Snipaste_2020-09-27_10-41-03.png)
...
* ![创建Spring Boot工程](SpringBoot.assets/Snipaste_2020-09-27_10-49-50.png)
...
![maven配置](SpringBoot.assets/Snipaste_2020-09-27_10-47-49.png)
...
![编码配置](SpringBoot.assets/Snipaste_2020-09-27_10-48-08.png)
...
![Spring Boot项目工程结构](SpringBoot.assets/Snipaste_2020-09-27_10-48-38.png)
...
```
![image-20201029105233289](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20201029105233289.png)
