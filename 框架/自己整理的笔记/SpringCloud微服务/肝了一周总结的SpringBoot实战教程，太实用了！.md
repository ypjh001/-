...
## [前言](http://www.macrozheng.com/#/reference/springboot_start?id=前言)
...
## [简介](http://www.macrozheng.com/#/reference/springboot_start?id=简介)
...
## [开始使用](http://www.macrozheng.com/#/reference/springboot_start?id=开始使用)

### [创建应用](http://www.macrozheng.com/#/reference/springboot_start?id=创建应用)

> 创建SpringBoot应用的方式有很多种，这里使用最流行的开发工具IDEA来创建应用。

- 首先通过`File->New Project`来创建一个项目；

![img](http://www.macrozheng.com/images/springboot_start_01.png)

- 然后选择通过`Spring Initializr`来创建一个SpringBoot应用；

![img](http://www.macrozheng.com/images/springboot_start_02.png)

- 填写好Maven项目的`groupId`和`artifactId`及选择好Java版本；

![img](http://www.macrozheng.com/images/springboot_start_03.png)

- 选择好起步依赖，这里选择的是开启Web功能的起步依赖；

![img](http://www.macrozheng.com/images/springboot_start_04.png)

- 选择好项目的存放位置即可顺利创建一个SpringBoot应用。

![img](http://www.macrozheng.com/images/springboot_start_05.png)

### [查看应用](http://www.macrozheng.com/#/reference/springboot_start?id=查看应用)

#### [项目结构](http://www.macrozheng.com/#/reference/springboot_start?id=项目结构)
...
└─src
   ...
   └─test
       └─java
           └─MallTinyApplicationTests.java # 基本的集成测试类Copy to clipboardErrorCopied
```

#### [应用启动类](http://www.macrozheng.com/#/reference/springboot_start?id=应用启动类)
...
#### [测试应用](http://www.macrozheng.com/#/reference/springboot_start?id=测试应用)
...
#### [编写应用配置](http://www.macrozheng.com/#/reference/springboot_start?id=编写应用配置)

当我们需要微调自动配置的参数时，可以在`application.yml`文件中进行配置，比如微调下端口号。

```yaml
server:
  port: 8088Copy to clipboardErrorCopied
```

#### [项目构建过程](http://www.macrozheng.com/#/reference/springboot_start?id=项目构建过程)
...
### [使用起步依赖](http://www.macrozheng.com/#/reference/springboot_start?id=使用起步依赖)

#### [使用起步依赖的好处](http://www.macrozheng.com/#/reference/springboot_start?id=使用起步依赖的好处)
...
![img](http://www.macrozheng.com/images/springboot_start_06.png)

#### [指定基于功能的依赖](http://www.macrozheng.com/#/reference/springboot_start?id=指定基于功能的依赖)
...
#### [覆盖起步依赖中的库](http://www.macrozheng.com/#/reference/springboot_start?id=覆盖起步依赖中的库)
...
### [使用自动配置](http://www.macrozheng.com/#/reference/springboot_start?id=使用自动配置)
...
## [自定义配置](http://www.macrozheng.com/#/reference/springboot_start?id=自定义配置)

### [自定义Bean覆盖自动配置](http://www.macrozheng.com/#/reference/springboot_start?id=自定义bean覆盖自动配置)
...
### [自动配置微调](http://www.macrozheng.com/#/reference/springboot_start?id=自动配置微调)
...
spring:
  datasource:
    url: jdbc:mysql://localhost:3306/mall?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai
    username: root
    password: rootCopy to clipboardErrorCopied
```

### [读取配置文件的自定义属性](http://www.macrozheng.com/#/reference/springboot_start?id=读取配置文件的自定义属性)
...
secure:
  ignored:
    urls:
      ...
      - /**/*.js
      - /swagger-resources/**
      - /v2/api-docs/**Copy to clipboardErrorCopied
```
...
## [Actuator](http://www.macrozheng.com/#/reference/springboot_start?id=actuator)

SpringBoot Actuator的关键特性是在应用程序里提供众多Web端点，通过它们了解应用程序运行时的内部状况。

### [端点概览](http://www.macrozheng.com/#/reference/springboot_start?id=端点概览)
...
### [查看配置明细](http://www.macrozheng.com/#/reference/springboot_start?id=查看配置明细)
...
### [查看运行时度量](http://www.macrozheng.com/#/reference/springboot_start?id=查看运行时度量)
...
### [关闭应用](http://www.macrozheng.com/#/reference/springboot_start?id=关闭应用)
...
### [定制Actuator](http://www.macrozheng.com/#/reference/springboot_start?id=定制actuator)
...
management:
  endpoints:
    web:
      base-path: /monitorCopy to clipboardErrorCopied
```

## [常用起步依赖](http://www.macrozheng.com/#/reference/springboot_start?id=常用起步依赖)

起步依赖不仅能让构建应用的依赖配置更简单，还能根据提供给应用程序的功能将它们组织到一起，这里整理了一些常用的起步依赖。

### [官方依赖](http://www.macrozheng.com/#/reference/springboot_start?id=官方依赖)
...
### [第三方依赖](http://www.macrozheng.com/#/reference/springboot_start?id=第三方依赖)
